...
class CircleProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (backgroundColor != null) {
      final backgroundPaint = Paint()
        ...
        ..strokeWidth = strokeWidth
        ..style = PaintingStyle.stroke;
      canvas.drawCircle(center, shortestSide / 2, backgroundPaint);
    }

    final rect = Rect.fromCircle(center: center, radius: shortestSide / 2);
    final gradient = SweepGradient(colors: gradientColors);
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    ...
    return oldPainter.percentage != percentage ||
        ...
        oldPainter.gradientColors != gradientColors ||
